...
export default function Step4GymConsent({ data, onDataChange, onNext, onBack, onSkipPhoto }: Step4Props) {
  const isValid = data.gymName.trim() !== '' && data.equipmentMethod && data.consentGiven;
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>Let's set up your gym equipment and confirm your consent</Text>
      ...
      <View style={styles.section}>
        ...
        >
          <View style={styles.methodHeader}>
            ...
            <View style={styles.methodContent}>
              <Text style={[styles.methodTitle, data.equipmentMethod === 'photo' && styles.methodTitleActive]}>
        ...
        >
          <View style={styles.methodHeader}>
            ...
            <View style={styles.methodContent}>
              <Text style={[styles.methodTitle, data.equipmentMethod === 'skip' && styles.methodTitleActive]}>
                Skip for Now
              </Text>
              <Text style={styles.methodDesc}>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity
          ...
          onPress={() => onDataChange({ ...data, consentGiven: !data.consentGiven })}
        >
          ...
          <Text style={styles.consentText}>
            I consent to storing my data for personalized fitness recommendations
          </Text>
        </TouchableOpacity>
      </View>
