    ...
    <div className="space-y-6">
                    ...
                    return (
                      <Button
                        ...
                        className={cn(
                          ...
                          workoutBorderClass,
                          workoutBgClass,
                          isSelected ? "ring-2 ring-primary" : "opacity-50", // Dim unselected workouts
      ...
      <Card
        className={cn(
          ...
          (selectedWorkoutId === 'ad-hoc' || isAdHocExpanded) ? "border-primary ring-2 ring-primary" : "opacity-50" // Dim ad-hoc if not selected
        )}
