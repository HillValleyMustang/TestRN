...
export const useManageExercisesData = ({ sessionUserId, supabase, setTempStatusMessage, userGyms, exerciseGymsMap, availableMuscleGroups, exerciseWorkoutsMap }: UseManageExercisesDataProps) => {
