...
import { CalendarDays, Bike, Swimmer, TennisBall } from "lucide-react"; // Fixed: Changed Tennis to TennisBall
        ...
        {!selectedActivity ? (
          <div className="grid gap-4 py-4">
            ...
            <Button variant="outline" onClick={() => handleActivitySelect("Swimming")}>
              <Swimmer className="h-4 w-4 mr-2" /> Log Swimming
            </Button>
            <Button variant="outline" onClick={() => handleActivitySelect("Tennis")}>
              <TennisBall className="h-4 w-4 mr-2" /> Log Tennis {/* Fixed: Changed Tennis to TennisBall */}
            </Button>
          </div>
        ) : (
          <div className="py-4">
