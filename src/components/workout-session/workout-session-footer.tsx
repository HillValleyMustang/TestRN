...
<dyad-write path="src/components/workout-flow/workout-selector.tsx" description="Implemented exercise caching and adjusted layout for better mobile experience">
"use client";
