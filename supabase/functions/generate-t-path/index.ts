  ...
  rawCsvData
    ...
    if (!uniqueMap.has(exerciseId)) {
      uniqueMap.set(exerciseId, {
        ...
        icon_url: toNullIfEmpty(row.icon_url),
      });
    }
  });
